...
public class EmprunterCtl {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException, IOException {
		...
		String h = JOptionPane.showInputDialog(null, "Entrez l'ID de l'exemplaire : ","Recherche d'un exemplaire", JOptionPane.INFORMATION_MESSAGE);
		...
		String k = JOptionPane.showInputDialog(null, "Entrez l'ID de l'utilisateur que vous souhaitez consulter : ","Recherche d'un utilisateur", JOptionPane.INFORMATION_MESSAGE);
		System.out.println("Troisième demande : "+utilisateur1.findByKey(Integer.parseInt(k)).toString());
		
		System.out.println("\n-------------Test 3.2 : Retour de tous les exemplaires-----------------------");
		int j = JOptionPane.showConfirmDialog(null, "Voulez-vous voir tous les exemplaires ? ","Liste des exemplaires",JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
		if (j==0) {
